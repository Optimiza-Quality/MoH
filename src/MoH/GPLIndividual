...
public class GPLIndividual extends GPLInternal{
	...
	public void SubmitIndividualApp_Case4800() throws InterruptedException, IOException{
		...
		FileUtils.copyFile(source, new File("./GPL-Individual-ScreenShots/Case4.8.0.0.png"));

		System.out.println("Passed. Individual Pharmacist Case 4.8.0.0");
	...
	@Test(priority = 14, groups = {"Own", "Commitment"})
	public void SubmitIndividualApp_Case4820() throws InterruptedException, IOException{
		
		// الصيدلي يمتلك صيدلية - اغلاق
