...
//nouf
	...
	public void HealthInstitute_Case2000() throws InterruptedException, IOException {
		...
		String ExpectedErrorMessage = "Êã ÊÞÏíã ØáÈß ÈäÌÇÍ";
	...
	public void HealthInstitute_Case2200() throws InterruptedException, IOException {
		...
		Thread.sleep(Const * 10);
		String ExpectedErrorMessage = "ÑÞã ÞíÏ ÇáãäÔÃÉ ÇáæØäí ÛíÑ ãæÌæÏ¡ áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ. íÑÌì ãÑÇÌÚÉ æÒÇÑÉ ÇáÕÍÉ áÅäÔÇÁ ÍÓÇÈ ÎÇÕ Èß. áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
	...
	public void HealthInstitute_Case2210() throws InterruptedException, IOException {
		...
		System.out.println("Actual Message: " + ActualErrorMessage);
		Thread.sleep(Const * 10);
		String ExpectedErrorMessage = "ÇáÑÞã ÇáÎÇÕ ÛíÑ ãØÇÈÞ¡ áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ. íÑÌì ÇáÊÃßÏ ãä ÕÍÉ ÇáÑÞã ÇáÎÇÕ. áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		// ---------------ScreenShot--------------------
		TakesScreenshot ts = (TakesScreenshot) driver;
	...
	public void HealthInstitute_Case2300() throws InterruptedException, IOException {
		...
		System.out.println("Actual Message: " + ActualErrorMessage);
		Thread.sleep(Const * 10);
		String ExpectedErrorMessage = "áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ áÅÕÏÇÑ ÊÕÑíÍ ãÒÇæáÉ ãåäÉ ããÑÖ ÞÇäæäí äÙÑÇ áæÌæÏ ØáÈ ÊÕÑíÍ ãÒÇæáÉ ãåäÉ ããÑÖ ÞÇäæäí ÓÇÈÞ ÑÞã áÏíß áÇíÒÇá ÞíÏ ÇáÊäÝíÐ¡ áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		// ------------------ScreenShot---------------
		TakesScreenshot ts = (TakesScreenshot) driver;
	...
	public void HealthInstitute_Case2400() throws InterruptedException, IOException {
		...
		System.out.println("Actual Message: " + ActualErrorMessage);
		Thread.sleep(Const * 10);
		String ExpectedErrorMessage = "áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ áÅÕÏÇÑ ÊÕÑíÍ ãÒÇæáÉ ãåäÉ ããÑÖ ÞÇäæäí äÙÑÇ áæÌæÏ ÊÕÑíÍ ãÒÇæáÉ ãåäÉ ããÑÖ ÞÇäæäí ÓÇÈÞ ÝÚÇá áÏì ÇáãÄÓÓÉ ÇáÕÍíÉ ÇáãÞÏãÉ ááØáÈ. áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		// ------------------ScreenShot---------------
		TakesScreenshot ts = (TakesScreenshot) driver;
	...
	public void HealthInstitute_Case2500() throws InterruptedException, IOException {
		...
		System.out.println("Actual Message: " + ActualErrorMessage);
		Thread.sleep(Const * 10);
		String ExpectedErrorMessage = "ÇáÑÞã ÇáÔÎÕí ÇáãÏÎá ÛíÑ ÕÍíÍ¡ áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ. íÑÌì ÇáÊÃßÏ ãä ÕÍÉ ÇáÑÞã ÇáÔÎÕí. áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		// ------------------ScreenShot---------------
		TakesScreenshot ts = (TakesScreenshot) driver;
	...
	public void HealthInstitute_Case2510() throws InterruptedException, IOException {
		...
		System.out.println("Actual Message: " + ActualErrorMessage);
		Thread.sleep(Const * 10);
		String ExpectedErrorMessage = "ÊÇÑíÎ ÇáãíáÇÏ ÛíÑ ãØÇÈÞ¡ áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ. íÑÌì ÇáÊÃßÏ ãä ÕÍÉ ÊÇÑíÎ ÇáãíáÇÏ. áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		// ------------------ScreenShot---------------
		TakesScreenshot ts = (TakesScreenshot) driver;
	...
	public void HealthInstitute_Case2600() throws InterruptedException, IOException {
		...
		Thread.sleep(Const * 10);
		driver.findElement(NotesAttachmentCases).sendKeys("ÓÚíÏ"); // Notes
		Thread.sleep(Const * 10);
	...
	public void HealthInstitute_Case2700() throws InterruptedException, IOException {
		...
		System.out.println("Actual Message: " + ActualErrorMessage);
		Thread.sleep(Const * 10);
		String ExpectedErrorMessage = "áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ äÙÑÇ áÃä ãÚáæãÇÊ ÇáÈßÇáæÑíæÓ ÇáãÏÎáÉ ÛíÑ ÕÍíÍÉ , áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		// ------------------ScreenShot---------------
		TakesScreenshot ts = (TakesScreenshot) driver;
	...
	public void HealthInstitute_Case2720() throws InterruptedException, IOException {
		...
		Thread.sleep(Const * 10);
		Select UniversityCountry = new Select(driver.findElement(UniversityCountryDDL));
		UniversityCountry.selectByVisibleText("ÝÑäÓÇ");
		// UniversityCountry.selectByIndex(139); // Jordan
	...
	public void HealthInstitute_Case2721() throws InterruptedException, IOException {
		...
		System.out.println("Actual Message: " + ActualErrorMessage);
		Thread.sleep(Const * 10);
		String ExpectedErrorMessage = "áÇ íãßäß ÇÓÊãÇá ÊÞÏíã ÇáØáÈ äÙÑÇ áÃä ãÚáæãÇÊ ÇáÈßÇáæÑíæÓ ÇáãÏÎáÉ ÛíÑ ÕÍíÍÉ , áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		// ------------------ScreenShot---------------
		TakesScreenshot ts = (TakesScreenshot) driver;
	...
	public void HealthInstitute_Case2730() throws InterruptedException, IOException {
		...
		System.out.println("Actual Message: " + ActualErrorMessage);
		Thread.sleep(Const * 10);
		String ExpectedErrorMessage = "áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ¡ äÙÑÇ áÚÏã ÅÓÊÑÌÇÚ ãÚáæãÇÊ ÇáÈßÇáæÑíæÓ ¡ íÑÌì ãÑÇÌÚÉ æÒÇÑÉ ÇáÊÚáíã ÇáÚÇáí æÇáÈÍË ÇáÚáãí áÊÕæíÈ ÇáÃæÖÇÚ áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		// ------------------ScreenShot---------------
		TakesScreenshot ts = (TakesScreenshot) driver;
	...
	public void HealthInstitute_Case2740() throws InterruptedException, IOException {
		...
		System.out.println("Actual Message: " + ActualErrorMessage);
		Thread.sleep(Const * 10);
		String ExpectedErrorMessage = "áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ äÙÑÇ áÃä ÊÎÕÕß áíÓ ÊÇÈÚ áßáíÉ ÇáÊãÑíÖ¡ íÑÌì ãÑÇÌÚÉ æÒÇÑÉ ÇáÊÚáíã ÇáÚÇáí æÇáÈÍË ÇáÚáãí áÊÕæíÈ ÇáÃæÖÇÚ áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		// ------------------ScreenShot---------------
		TakesScreenshot ts = (TakesScreenshot) driver;
	...
	public void HealthInstitute_Case2800() throws InterruptedException, IOException {
		...
		System.out.println("Actual Message: " + ActualErrorMessage);
		Thread.sleep(Const * 10);
		String ExpectedErrorMessage = "áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ¡ áÅÕÏÇÑ ÊÕÑíÍ ãÒÇæáÉ ãåäÉ ããÑÖ ÞÇäæäí íÑÌì ÅÕÏÇÑ ÔåÇÏÉ ÚÏã ãÍßæãíÉ ÈÇÓÊÎÏÇã ÇáÑÇÈØ ÇáÊÇáí: ÅÕÏÇÑ ÔåÇÏÉ ÚÏã ãÍßæãíÉ. áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		// ------------------ScreenShot---------------
		TakesScreenshot ts = (TakesScreenshot) driver;
	...
	public void HealthInstitute_Case2810() throws InterruptedException, IOException {
		...
		System.out.println("Actual Message: " + ActualErrorMessage);
		Thread.sleep(Const * 10);
		String ExpectedErrorMessage = "áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ØáÈ ÅÕÏÇÑ ÊÕÑíÍ ãÒÇæáÉ ãåäÉ ããÑÖ ÞÇäæäí áæÌæÏ ÎØÃ Ýí ÇáãÚáæãÇÊ ÇáãÓÊÑÌÚÉ áÔåÇÏÉ ÚÏã ÇáãÍßæãíÉ. áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		// ------------------ScreenShot---------------
		File source = ts.getScreenshotAs(OutputType.FILE);
	...
	public void HealthInstitute_Case2820() throws InterruptedException, IOException {
		...
		System.out.println("Actual Message: " + ActualErrorMessage);
		Thread.sleep(Const * 10);
		String ExpectedErrorMessage = "áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ áÅÕÏÇÑ ÊÕÑíÍ ãÒÇæáÉ ãåäÉ ããÑÖ ÞÇäæäí äÙÑÇ áÃä ÔåÇÏÉ ÚÏã ÇáãÍßæãíÉ ÇáÕÇÏÑÉ ÞÏ ÊÌÇæÒÊ ÇáËáÇË ÃÔåÑ ãä ÊÇÑíÎ ÅÕÏÇÑåÇ¡ íÑÌì ÅÕÏÇÑ ÔåÇÏÉ ÚÏã ãÍßæãíÉ ÍÏíËÉ ÈÇÓÊÎÏÇã ÇáÑÇÈØ ÇáÊÇáí: ÅÕÏÇÑ ÔåÇÏÉ ÚÏã ãÍßæãíÉ. áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
	...
	public void HealthInstitute_Case2900() throws InterruptedException, IOException {
		...
		// ----------------Assert--------------------
		String ActualErrorMessage = driver.findElement(ErrorMessage).getText();
		String ExpectedErrorMessage = "áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ äÙÑÇ áÃäß ÛíÑ ãäÊÓÈ ááäÞÇÈÉ íÑÌì ÇáÇäÊÓÇÈ ááäÞÇÈÉ æãä Ëã ÊÞÏíã ØáÈ ÊÕÑíÍ ãÒÇæáÉ ãåäÉ ããÑÖ ÞÇäæäí. áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 06500454";
		System.out.println("Actual Message: " + ActualErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		// ------------ScreenShot---------------------
	...
	public void HealthInstitute_Case2910() throws InterruptedException, IOException {
		...
		// ----------------Assert--------------------
		String ActualErrorMessage = driver.findElement(ErrorMessage).getText();
		String ExpectedErrorMessage = "áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ äÙÑÇ áÃäß ÛíÑ ãÓÏÏ ááÑÓæã ÇáãÊÑÊÈÉ Úáíß Ýí ÇáäÞÇÈÉ íÑÌì ÊÓÏíÏ ÑÓæã ÇáäÞÇÈÉ æãä Ëã ÊÞÏíã ØáÈ ÊÕÑíÍ ãÒÇæáÉ ãåäÉ ããÑÖ ÞÇäæäí. áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("Actual Message: " + ActualErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		// ------------ScreenShot---------------------
	...
	public void HealthInstitute_Case2920() throws InterruptedException, IOException {
		...
		// ----------------Assert--------------------
		String ActualErrorMessage = driver.findElement(ErrorMessage).getText();
		String ExpectedErrorMessage = "áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ äÙÑÇ áÍÏæË ÎØÃ Ýí ÅÓÊÑÌÇÚ ãÚáæãÇÊß ãä äÞÇÈÉ ÇáããÑÖíä¡ íÑÌì ãÑÇÌÚÉ äÞÇÈÉ ÇáããÑÖíä ááÊÃßÏ ãä ÇáÅäÊÓÇÈ æáÊÃßÏ ãä ÕÍÉ ÈíÇäÇÊß¡ áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("Actual Message: " + ActualErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		// ------------ScreenShot---------------------
	...
	public void HealthInstitute_Case21000() throws InterruptedException, IOException {
		...
		// ----------------Assert--------------------
		String ActualErrorMessage = driver.findElement(ErrorMessage).getText();
		String ExpectedErrorMessage = "áÇ íãßäß ÇÓÊßãÇá ÊÞÏíã ÇáØáÈ áÅÕÏÇÑ ÊÕÑíÍ ãÒÇæáÉ ãåäÉ ããÑÖ ÞÇäæäí äÙÑÇ áÃäå ÞÏ Êã ÑÝÖ ØáÈß ãä ÃÞá ãä 3 ÔåæÑ. áãÒíÏ ãä ÇáãÚáæãÇÊ íÑÌì ÇáÅÊÕÇá Úáì ÇáÎØ ÇáÓÇÎä áæÒÇÑÉ ÇáÕÍÉ 065004545";
		System.out.println("Actual Message: " + ActualErrorMessage);
		Assert.assertTrue(ActualErrorMessage.contains(ExpectedErrorMessage));
		System.out.println("ExpectedErrorMessage: " + ExpectedErrorMessage);
		// ------------ScreenShot---------------------
